                ...
                <div class="card-body">
                    ...
                    <div class="row" id="divAdd">
                        ...
                        <div class="col-sm-12 text-center mt-20 @if($isEdit && $EditData[0]->BannerType == "Mobile") d-none @endif" id="divWeb">
                           ...
                           <label class="mt-20">Web Banner Image <span class="fs-13" style="color:rgba(0,0,0,0.75)" id="lblBanner"> (Upload Ratio=1600px X 518px)</span></label>
                            <input type="file" class="dropify imageScrop" id="txtBanner" data-min-width=1600 data-min-height=518 data-max-width=1600 data-max-height=518 data-default-file="@if($isEdit && $EditData[0]->BannerType == "Web"){{url('/')."/".$EditData[0]->BannerImage}}@endif"  data-allowed-file-extensions="jpeg jpg png gif">
                        </div>
