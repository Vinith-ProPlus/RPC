			...
			<div class="card">
				...
				<div class="card-body " >
                    <div id="order_filter" class="row d-flex justify-content-center m-5 mb-2">
                        ...
                        <div class="col-sm-3 justify-content-Center d-none">
                            <div class="form-group text-center mh-60">
...
<script>
    $(document).ready(function(){
			...
			@if($crud['view']==1)
				...
				tblLedger=$('#tblLedger').dataTable( {
					...
					ajax: {
						...
						url: "{{route('admin.reports.outstandings.data')}}?_token="+$('meta[name=_token]').attr('content'),
        ...
        $(document).on('click','.btnLedgerDetails',function(e){
            ...
            href+="?b=rpt-os&ltype="+ltype+"&from="+fromDate+"&to="+toDate;
