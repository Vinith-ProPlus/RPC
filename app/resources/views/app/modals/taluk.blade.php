<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <span class="errors New-Taluk-err" id="lstMCountry-err"></span>
        </div>
    </div>
    <div class="col-sm-12  mt-20">
        <div class="form-group">
            ...
            <span class="errors New-Taluk-err" id="lstMState-err"></span>
        </div>
    </div>
    <div class="col-sm-12  mt-20">
        <div class="form-group">
            ...
            <span class="errors New-Taluk-err" id="lstMDistrict-err"></span>
        </div>
    </div>
    <div class="col-sm-12  mt-20">
        <div class="form-group">
            <label for="txtMTalukName">Taluk Name <span class="required">*</span></label>
            <input type="text" id="txtMTalukName"  class="form-control  {{$Theme['input-size']}}" placeholder="Enter Taluk Name"  value="" autofocus>
            <span class="errors New-Taluk-err" id="txtMTalukName-err"></span>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12  mt-30 text-right">
        ...
        <button id="btnCreateTaluk" type="button" class="btn btn-outline-success btn-air-success {{$Theme['button-size']}} ">Create</button>
    </div>
</div>
<script>
