								...
								<div class="search pt-10">
									<div class="mb-3">
										<div class="input-group">
											...
											<button class="btn btn-dark pl-10 pr-10"><span class="fa fa-search"></span></button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col pe-0 chat-right-aside">
							...
							<div class="chat">
								...
								<div class="chat-header clearfix">
									<div class="row">
										<div class="col-6">
											<div class="name">Anandhan AS <span class="last-seen">last seen today at 02:50 PM</span></div>
										...
										<div class="col-2"></div>
										<div class="col-4">
											<div class="mobile-number">7708679203 <a href="tel:7708679203" class="btn btn-sm btn-dark ml-30">Call now</a></div>
									...
									<ul>
										...
										<li class="clearfix reply">
											<div class="message other-message pull-right">
												<p>Well I am not sure. The rest of the team is not here yet. Maybe in an hour or so?</p>
												<span class="time">10:20 am</span>
											</div>
										</li>
									</ul>
