...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-12 col-sm-12 col-lg-5">
			<div class="card">
				<div class="card-header text-center"><h5>Password Change</h5></div>
				<div class="card-body">
                    <div class="row mt-20">
                    	<div class="col-12 col-sm-12">
                        	<div class="form-group">
                            	<label for="txtCurrentPassword">Current Password <span class="required">*</span></label>
                                <input type="password" id="txtCurrentPassword" class="form-control  {{$Theme['input-size']}}" placeholder="Current Password" value="">
                                <span class="errors err-sm" id="txtCurrentPassword-err"></span>
                            </div>
                        </div>
					</div>
					<div class="row mt-20">
                        <div class="col-12 col-sm-12">
                            <div class="form-group">
								...
								<input type="password" id="txtNewPassword" class="form-control  {{$Theme['input-size']}}" placeholder="New Password" value="">
								<span class="errors err-sm" id="txtNewPassword-err"></span>
                            </div>
                        </div>
                    </div>
					<div class="row mt-20">
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-sm-12 text-right">
							<button id="btnChangePassword" type="button" class="btn btn-outline-success {{$Theme['button-size']}}">Change Password</button>
						</div>
					</div>
				</div>
			</div>
