                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$Theme['input-size']}}" id="txtPCName" value="<?php if($isEdit==true){ echo $EditData[0]->PCName;} ?>">
...
<script>
    $(document).ready(function(){
        ...
        const formValidation=async()=>{
            ...
            if(PCName==""){
                $('#txtPCName-err').html('The Product Category name is required.');status=false;
            }else if(PCName.length<2){
                $('#txtPCName-err').html('Product Category Name must be greater than 2 characters');status=false;
            }else if(PCName.length>100){
                $('#txtPCName-err').html('Product Category Name may not be greater than 100 characters');status=false;
            }
