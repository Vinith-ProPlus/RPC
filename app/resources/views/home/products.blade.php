...
@section('content')
    ...
    <style>
        ...
        @font-face {
            ...
            src:url("../assets/fonts/porto.eot?64334846#iefix") format("embedded-opentype"),
            url("../assets/fonts/porto.woff2?64334846") format("woff2"),
            url("../assets/fonts/porto.woff?64334846") format("woff"),
            url("../assets/fonts/porto.ttf?64334846") format("truetype"),
            url("../assets/fonts/porto.svg?64334846#porto") format("svg");
            font-style:normal;
            font-weight:normal;
            font-display:swap
        }
        ...
        .header-dropdown.dropdown-expanded li a {
            display:inline-block
        }
        .header-dropdown.dropdown-expanded li:not(:first-child):before {
            content:"|";
            display:inline-block;
            vertical-align:top;
        ...
        .page-header-bg .btn:not(:hover):not(:active) {
...
{{--                                        <option value="price-desc">Sort by price: high to low</option>--}}
            ...
            <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
                <div class="pin-wrapper" style="height: 904.35px;"><div class="sidebar-wrapper" style="border-bottom: 0px rgb(119, 119, 119); width: 335px;">
                        <div class="widget">
...
@section('scripts')
    <script>
        $(document).ready(function(){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        $(".sub-category").on('click', function(e) {
                            e.preventDefault();
                            console.log("Sub-category clicked."); // Check if event handler is being triggered
                            console.log("Sub-category ID:", $(this).data('sub-category-id')); // Check sub-category ID
                            sub_category_id = $(this).data('sub-category-id');
                            LoadProducts($(this).data('sub-category-id'), 1);
            ...
            const LoadProducts = async (sub_category_id, pageNo) => {
                var formData = new FormData();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#productCountSelect').change(function() {
                            LoadProducts(sub_category_id, current_page_no);
                        });
                        $('#productCountSelect2').change(function() {
                            LoadProducts(sub_category_id, current_page_no);
                        });
