...
<div class="container mt-20 pt-40" style="margin-top: 20px !important;">
<div class="content-header row">
        <div class="content-header-left col-md-8 col-12 mt-20 mb-2 ">
...
{{--                @endif--}}
{{--                <a type="button" href="{{url('/')}}/customer/support/" class="btn btn-outline-dark"> <i class="fa fa-reply-all" aria-hidden="true"></i> Back</a>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    @endif--}}
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            @if(count($SupportDetails[$i]->Attachments)>0)
                                                <div class="row attachments mt-20 ml-10 mt-1">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <div class="row mb-1">
                                    <div class="col-sm-3"><label>Attachments</label></div>
{{--                                    <label>Attachments</label>--}}
                                </div>
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <input type="file" id="imgAttachment1" class="dropify Attachments" data-default-file=""  data-max-file-size="20M"  data-allowed-file-extensions='jpeg jpg png gif webp bmp pdf' autocomplete="off"  /><span class="errors" id="imgAttachment1-err"></span>
                                            <span class="errors" id="imgAttachment1-err"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <input type="file" id="imgAttachment2" class="dropify Attachments" data-default-file=""  data-max-file-size="20M"  data-allowed-file-extensions='jpeg jpg png gif webp bmp pdf' autocomplete="off"  /><span class="errors" id="imgAttachment2-err"></span>
                                            <span class="errors" id="imgAttachment2-err"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <input type="file" id="imgAttachment3" class="dropify Attachments" data-default-file=""  data-max-file-size="20M"  data-allowed-file-extensions='jpeg jpg png gif webp bmp pdf' autocomplete="off"  /><span class="errors" id="imgAttachment3-err"></span>
                                            <span class="errors" id="imgAttachment3-err"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <input type="file" id="imgAttachment4" class="dropify Attachments" data-default-file=""  data-max-file-size="20M"  data-allowed-file-extensions='jpeg jpg png gif webp bmp pdf' autocomplete="off"  /><span class="errors" id="imgAttachment4-err"></span>
...
{{--                    <!--<button type="button" class="btn btn-outline-dark SupportTicketDelete"> <i class="fa fa-trash" aria-hidden="true"></i> Delete</button>-->--}}
{{--                @endif--}}
                <a type="button" href="{{ route('my-account', ['tab' => 'support']) }}" class="btn btn-outline-dark"> <i class="fa fa-reply-all" aria-hidden="true"></i> Back</a>
            </div>
        </div>
    </div>
    @endif
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','.SupportTicketClose',function(){
                ...
                $.ajax({
                    type:"post",
                    url:"{{url('/')}}/customer/support/deactivate/{{$SID}}",
                    headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                    success:function(response){
                        window.location.replace("{{url('/')}}/customer/support/");
            ...
            $(document).on('click','.SupportTicketDelete',function(){
                ...
                function(){
                    $.ajax({
                        type:"post",
                        url:"{{url('/')}}/customer/support/delete/{{$SID}}",
                        headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') },
                        success:function(response){
                            window.location.reload();
                        }
