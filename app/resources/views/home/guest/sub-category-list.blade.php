...
<head>
    ...
    <link rel="preload" href="{{ url('/') }}/home/assets/vendor/fontawesome-free/webfonts/fa-regular-400.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload" href="{{ url('/') }}/home/assets/vendor/fontawesome-free/webfonts/fa-solid-900.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload" href="{{ url('/') }}/home/assets/vendor/fontawesome-free/webfonts/fa-brands-400.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ url('/') }}/home/assets/vendor/fontawesome-free/css/all.min.css">
...
<body>
                                ...
                                <div class="info-box info-box-icon-left justify-content-start">
                                    ...
                                    <div class="align-middle"
                                        ...
                                        <h6 class="d-flex font-weight-bold text-dark"
                                            ...
                                            <span class="delivery-location-sm-hide">Delivery Location - &nbsp;</span>
                                            {{ $PostalCode }}
                ...
                <div class="container">
                    <div class="header-left col-lg-2 w-auto pl-0">
                        <a href="{{ url('/') }}" class="logo">
                            <img loading="lazy" src="{{ url('/') }}/{{ $Company['Logo'] }}" width="50"
                                height="50" alt="{{ $Company['CompanyName'] }}">
                        </a>
                    ...
                    <div class="header-right w-lg-max">
                        ...
                        <div class="dropdown mobileVendorDropdown ml-0 pr-5">
                            <a href="#" role="button" id="threeDotsDropdown" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="true">
                                <i class="fas fa-ellipsis-v"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="threeDotsDropdown"
                                x-placement="bottom-end"
                                style="position: absolute; transform: translate3d(-76px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                                <a class="dropdown-item border-bottom" href="#AppLinkDiv" style="font-size: 1.4rem;"
                                    id="btnBecVen">Become&nbsp;a&nbsp;vendor</a>
                                <a class="dropdown-item border-bottom" href="#" id="btnPlanServ"
                                    style="font-size: 1.4rem;">FREE&nbsp;Building&nbsp;Plan</a>
                                <a class="dropdown-item" href="#" id="btnConstructionServ"
                                    style="font-size: 1.4rem;">Construction&nbsp;Service&nbsp;Plan</a>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu mobile-cart">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-action">
                                        <a href="{{ route('products.guest.productsList') }}"
                                            class="btn btn-dark btn-block">Add to Cart</a>
                        ...
                        <div class="py-2">
                            <div class="input-group" style="width: 100% !important;">
                                <input class="form-control" placeholder="Search..." type="text"
                                    id="mblHomeSearch" name="homeSearch">
                                    ...
                                    <li class="menu-item d-flex align-items-center">
                                        ...
                                        <div class="menu-depart">
                                            @foreach ($PCategories->take(5) as $row)
                                                <a
                                                    href="{{ route('products.guest.subCategoryList', ['CID' => $row->PCID]) }}">{{ $row->PCName }}</a>
                                            @endforeach
                                            <div
                                                style="text-align: center; display: flex; justify-content: center; align-items: center;">
                                                <a href="{{ route('products.guest.categoriesList') }}"
                                                    class="text-center">More</a>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('products.guest.categoriesList') }}">Categories</a></li>
                        ...
                        <div class="col-lg-2 col-sm-6 pb-2 pb-sm-0 d-flex align-items-center">
                            <div class="widget m-b-3">
                                <img loading="lazy" src="{{ url('/') }}/{{ $Company['Logo'] }}"
                                    alt="{{ $Company['CompanyName'] }}" width="202" height="54"
                                    class="logo-footer">
                        ...
                        <div class="col-lg-3 col-sm-6 pb-4 pb-sm-0">
                            <div class="widget mb-2">
                                ...
                                <ul class="contact-info">
                                    <li>
                                        <span
                                            class="contact-info-label">Address:</span>{{ $Company['Address'] }}<br>{{ $Company['AddressData']->CityName }},
                                        {{ $Company['AddressData']->DistrictName }},
                                        {{ $Company['AddressData']->StateName }},
                                        {{ $Company['AddressData']->CountryName }} -
                                        {{ $Company['AddressData']->PostalCode }}.
                                    </li>
                                    <li>
                                        <span class="contact-info-label">Phone:</span><a href="#">+91
                                            {{ $Company['Phone-Number'] }}@if ($Company['Mobile-Number'])
                            ...
                            <div class="widget">
                                ...
                                <ul class="links">
                                    @foreach (DB::table('tbl_page_content')->select('Slug', 'PageName')->get() as $Policy)
                                        <li><a
                                                href="{{ route('policies', $Policy->Slug) }}">{{ $Policy->PageName ?? '' }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div><!-- End .widget -->
                            ...
                            <div class="social-icons">
                                ...
                                @if (array_key_exists('twitter', $Company) && $Company['twitter'])
                                    <a href="{{ $Company['twitter'] }}"
                                        class="social-icon social-twitter fab fa-twitter" target="_blank"
                                        title="Twitter"></a>
                                @endif
            ...
            <div class="container">
                <div class="footer-bottom bg-dark text-center">
                    <div class="footer-left">
                        <span class="footer-copyright">{{ $Company['CompanyName'] }}. © 2024. All Rights
                            Reserved</span>
                    </div>
                </div>
    ...
    <div class="newsletter-popup mfp-hide bg-img p-0 h-auto" id="guest-login-form"
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="row justify-content-center mt-3">
                        <div class="col-md-4">
                            <img loading="lazy" src="{{ url('/') }}/{{ $Company['Logo'] }}"
                                alt="{{ $Company['CompanyName'] }}" class="logo-newsletter" width="50"
                                height="50">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 justify-content-center">
                            <a href="{{ url('/') }}/social/auth/google"
                                ...
                                onclick="localStorage.setItem('rpc_guest_redirect_url', window.location.href);">
                                <img src="{{ url('/assets/images/logo/google_sign_in_logo.png') }}"
                                    style="width: 60%;" class="img-fluid" alt="Google SignIn">
                            </a>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center mb-3">
                        ...
                        <div class="col-md-8 newsletter-popup-content d-none" id="divOtpInput">
                            <div class="input-group">
                                <input type="text" class="form-control" id="txtUserOtp" placeholder="Enter OTP"
                                    required="">
                            ...
                            <div class="text-center mt-2">
                                <button type="button" class="btn btn-link" id="btnResendOtp"
                                    onclick="$('#btnSubmitMobileNumber').click();">Resend OTP</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card border-0 mt-4">
                        <div class="card-header text-center border-0" @style('background:#ffffff')>
                            <h4 class="m-0">Get a
                                FREE Building Plan</h4>
                        </div>
                        <div class="card-body">
                            <div class="row my-3">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtPlanCustomerName" class="form-control"
                                            placeholder="Name">
                                ...
                                <div class="col-sm-6 mt-20">
                                    <div class="form-group">
                                        <label for="txtPlanMobileNo1">Mobile Number <span
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtPlanEmail" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="lstPlanServices">
                                            ...
                                            @foreach ($ServiceProvided as $items)
                                                <option value="{{ $items->ServiceID }}">{{ $items->ServiceName }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="txtPlanMessage" cols="0" rows="0" placeholder="Message"></textarea>
                                        <span class="errors Customer err-sm" id="txtPlanMessage-err"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <button class="btn btn-success mr-2" id="btnPlanServSave"
    ...
    <div class="newsletter-popup mfp-hide modal-sm bg-img p-0 h-auto" id="construction-serv-form"
                            ...
                            <div class="row my-3">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtConCustomerName" class="form-control"
                                            placeholder="Name">
                                ...
                                <div class="col-sm-6 mt-20">
                                    <div class="form-group">
                                        <label for="txtConMobileNo1">Mobile Number <span
                                                class="required">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtConEmail" class="form-control"
                                            placeholder="Email" value="">
                                ...
                                <div class="col-sm-6 mt-20">
                                    <div class="form-group">
                                        <label for="lstConServiceType" class="text-nowrap-430">Do you require any
                                            service related to construction<span class="hide-at-580-885">(Please click
                                                here)</span>:
                                        ...
                                        <select class="form-control" id="lstConServiceType">
                                            ...
                                            @foreach ($ConServiceCategories as $items)
                                                <option value="{{ $items->ConServCatID }}">
                                                    {{ $items->ConServCatName }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="txtConMessage" cols="0" rows="0" placeholder="Message"></textarea>
                                        <span class="errors ConCustomer err-sm" id="txtConMessage-err"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <button class="btn btn-success mr-2" id="btnConServSave"
                                    type="button">Submit</button>
                            </div>
                        </div>
                    </div>
        ...
        <button title="Close (Esc)" type="button" class="mfp-close mr-2" id="modal-close-btn"
            style="font-weight: bolder !important;">×</button>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function performSearch(resultsElementId, searchText) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        searchResults.empty();
                        searchResults.append((response.searchResults !== "") ? response.searchResults :
                            "No results found");
                        searchResults.show();
                    },
                    error: function(xhr, status, error) {
            ...
            $('#btnVerifyOtp').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            $('#txtUserOtp-err').text('');
                            localStorage.setItem('rpc_guest_redirect_url', window.location
                            .href);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        for (let Item of response) {
                            ...
                            $('#' + id).append('<option ' + selected +
                                ' data-taluk=""  value="' + Item.DistrictID + '">' + Item
                                .DistrictName + ' </option>');
                        }
                        if ($('#' + id).val() != "") {
                            $('#' + id).trigger('change');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        for (let Item of response) {
                            ...
                            $('#' + id).append('<option ' + selected + '  value="' + Item
                ...
                if (status) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status) {
                                $.magnificPopup.close();
                                $('#txtPlanCustomerName, #txtPlanMobileNo1, #txtPlanEmail, #lstPlanServices, #txtPlanMessage')
                                    .val('');
                                $('.errors.Customer').text('');
                            }
                        },
                ...
                if (status) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status) {
                                $.magnificPopup.close();
                                $('#txtConCustomerName, #txtConMobileNo1, #txtConEmail, #lstConServiceType, #lstConService, #txtConMessage')
                                    .val('');
                                $('.errors.ConCustomer').text('');
                            }
                        },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        for (let Item of response) {
                            ...
                            $('#' + id).append('<option ' + selected + ' value="' + Item
                                .ConServID + '">' + Item.ConServName + ' </option>');
                        }
                        if ($('#' + id).val() != "") {
                            $('#' + id).trigger('change');
                        }
            ...
            $(document).on("change", '#lstConServiceType', function() {
                getConService({
                    ConServCatID: $('#lstConServiceType').val()
                }, 'lstConService');
            });
        });
    </script>
