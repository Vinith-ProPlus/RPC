                ...
                <div class="container">
                    ...
                    <div class="header-right w-lg-max">
                        ...
                        <div class="dropdown mobileVendorDropdown ml-0 pr-5">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="threeDotsDropdown" x-placement="bottom-end"
                                ...
                                <a class="dropdown-item border-bottom" href="#" id="btnPlanServ" style="font-size: 1.4rem;">FREE&nbsp;Building&nbsp;Plan</a>
                                <a class="dropdown-item" href="#" id="btnConstructionServ" style="font-size: 1.4rem;">Construction&nbsp;Service&nbsp;Plan</a>
                            </div>
                        </div>
